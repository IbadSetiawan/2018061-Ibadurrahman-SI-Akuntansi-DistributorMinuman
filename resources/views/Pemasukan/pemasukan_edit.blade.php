        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/pemasukan/pemasukan_update" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="id_pemasukan" value="{{ $pemasukan->id_pemasukan }}">
                        ID Pemasukan :
                        <input type="password" class="form-control form-control-user" required="requeired" name="id_pemasukan" value="{{ $pemasukan->id_pemasukan }}">
                        ID Pegawai :
                        ...
                        Merk :
                        <input type="text" name="merk" class="form-control form-control-user" required="requeired" value="{{ $pemasukan->merk }}">
                        Kas Masuk :
                        <input type="int" name="kas_masuk" class="form-control form-control-user" required="requeired" value="{{ $pemasukan->kas_masuk }}">
                        Tanggal :
                        <input type="date" name="tanggal" class="form-control form-control-user" required="requeired" value="{{ $pemasukan->tanggal }}">
