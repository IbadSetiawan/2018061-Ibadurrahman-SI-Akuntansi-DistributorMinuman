    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="/pemasukan/pemasukan_tambah" class="btn btn-primary">
                        <span class="text">Tambah Data</span>
                    </a>
                    <a href="/pemasukan/pemasukan_cetak" target="_blank" class="btn btn-success">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $pemasukan->merk }}</td>
                                    <td>{{ $pemasukan->kas_masuk }}</td>
                                    <td>{{ $pemasukan->tanggal }}</td>
                                    <td><a href="/pemasukan/pemasukan_edit/{{ $pemasukan->id_pemasukan }}">Edit |</a>
                                        <a href="/pemasukan/pemasukan_hapus/{{ $pemasukan->id_pemasukan }}">Hapus</a>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
