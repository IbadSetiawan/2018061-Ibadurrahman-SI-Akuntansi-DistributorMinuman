...
<head>
    ...
    <title>SB Admin 2 - Suplier</title>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/suplier/suplier_update" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="id_suplier" value="{{ $suplier->id_suplier }}">
                        Id Suplier :
                        <input type="password" class="form-control form-control-user" required="requeired" name="id_suplier" value="{{ $suplier->id_suplier}}">
                        Nama Suplier :
                        <input type="text" name="nama_suplier" class="form-control form-control-user" required="requeired" value="{{ $suplier->nama_suplier }}">
                        No.Telpon :
                        <input type="varchar" name="no_telp" class="form-control form-control-user" required="requeired" value="{{ $suplier->no_telp }}">
                        Perusahaan :
                        <input type="varchar" name="perusahaan" class="form-control form-control-user" required="requeired" value="{{ $suplier->perusahaan }}">
                        Alamat :
                        <input type="varchar" name="alamat" class="form-control form-control-user" required=requeired value="{{ $suplier->alamat }}">
