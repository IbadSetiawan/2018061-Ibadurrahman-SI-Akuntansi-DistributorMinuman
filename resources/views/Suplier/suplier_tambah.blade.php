    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="/suplier/suplier_store" method="post">
                        {{csrf_field()}}
                        ID Suplier :
                        <input type="varchar" name="id_suplier" class="form-control form-control-user" required="requeired">
                        Nama Suplier :
                        <input type="text" name="nama_suplier" class="form-control form-control-user" required="requeired">
                        No.Telpon :
                        <input type="varchar" name="no_telp" class="form-control form-control-user" required="requeired">
                        Perusahaan :
                        <input type="varchar" name="perusahaan" class="form-control form-control-user" required="requeired">
                        Alamat :
