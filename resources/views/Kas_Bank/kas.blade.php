...
<head>
    ...
    <title>SB Admin 2 - Tabel Kasn & Bank</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Tabel Kas dan Bank</h1>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Data Kas dan Bank</h6>
                </div>
                <div class="card-body">
                    <a href="/kas/kas_tambah" class="btn btn-primary">
                        <span class="text">Tambah Data</span>
                    </a>
                    <a href="/kas/kas_cetak" target="_blank" class="btn btn-success">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $kas->kode_unik }}</td>
                                    <td>{{ $kas->id_pengeluaran }}</td>
                                    <td>{{ $kas->id_pemasukan }}</td>
                                    <td>{{ $kas->deskripsi }}</td>
                                    <td>{{ $kas->kas_keluar }}</td>
                                    <td>{{ $kas->kas_masuk}}</td>
                                    <td>{{ $kas->total }}</td>
                                    <td>{{ $kas->tanggal }}</td>
                                    <td><a href="/kas/kas_edit/{{ $kas->kode_unik }}">Edit |</a>
                                        <a href="/kas/kas_hapus/{{ $kas->kode_unik }}">Hapus</a>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
