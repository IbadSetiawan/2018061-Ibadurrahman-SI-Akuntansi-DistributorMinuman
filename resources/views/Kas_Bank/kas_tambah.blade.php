        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Data Kas & Bank</h6>
                </div>
                <div class="card-body">
                    <form action="/kas/kas_store" method="post">
                        {{csrf_field()}}
                        Kode Unik :
                        <input type="varchar" name="kode_unik" class="form-control form-control-user" required="requeired">
                        ID Pengeluaran :
                        ...
                        Deskripsi :
                        <input type="text" name="deskripsi" class="form-control form-control-user" required="requeired">
                        Kas Keluar :
                        <input type="int" name="kas_keluar" class="form-control form-control-user" required="requeired">
                        Kas Masuk :
                        <input type="int" name="kas_masuk" class="form-control form-control-user" required="requeired">
                        Total :
                        <input type="int" name="total" class="form-control form-control-user" required="requeired">
                        Tanggal :
