    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="/customer/customer_store" method="post">
                        {{csrf_field()}}
                        ID Customer :
                        <input type="varchar" name="id_customer" class="form-control form-control-user" required="requeired">
                        Nama Customer :
                        <input type="text" name="nama_customer" class="form-control form-control-user" required="requeired">
                        Alamat :
