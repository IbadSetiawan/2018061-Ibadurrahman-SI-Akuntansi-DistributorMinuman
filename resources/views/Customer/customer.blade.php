...
<head>
    ...
    <title>SB Admin 2 - Tabel Customer</title>
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="/customer/customer_tambah" class="btn btn-primary">
                        <span class="text">Tambah Data</span>
                    </a>
                    <a href="/customer/customer_cetak" target="_blank" class="btn btn-success">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/customer/customer_edit/{{ $customer->id_customer }}">Edit |</a>
                                        <a href="/customer/customer_edit/{{ $customer->id_customer }}">Hapus</a>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
