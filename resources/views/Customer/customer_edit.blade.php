...
<head>
    ...
    <title>SB Admin 2 - Customer</title>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/customer/customer_update" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="id_customer" value="{{ $customer->id_customer }}">
                        Id Customer :
                        <input type="password" class="form-control form-control-user" required="requeired" name="id_customer" value="{{ $customer->id_customer}}">
                        Nama Customer :
                        <input type="text" name="nama_customer" class="form-control form-control-user" required="requeired" value="{{ $customer->nama_customer }}">
                        Alamat :
                        <input type="varchar" name="alamat" class="form-control form-control-user" required=requeired value="{{ $customer->alamat }}">
                        No.Telpon :
                        <input type="varchar" name="no_telp" class="form-control form-control-user" required="requeired" value="{{ $customer->no_telp }}">
