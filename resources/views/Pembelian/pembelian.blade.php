    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="/pembelian/pembelian_tambah" class="btn btn-primary">
                        <span class="text">Tambah Data</span>
                    </a>
                    <a href="/pembelian/pembelian_cetak" target="_blank" class="btn btn-success">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $pembelian->kas_keluar }}</td>
                                    <td>{{ $pembelian->tanggal }}</td>
                                    <td><a href="/pembelian/pembelian_edit/{{ $pembelian->id_pembelian }}">Edit |</a>
                                        <a href="/pembelian/pembelian_hapus/{{ $pembelian->id_pembelian }}">Hapus</a>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
