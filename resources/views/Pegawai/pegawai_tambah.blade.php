    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="/pegawai/pegawai_store" method="post">
                        {{csrf_field()}}
                        ID Pegawai :
                        <input type="varchar" name="id_pegawai" class="form-control form-control-user" required="requeired">
                        Nama Pegawai :
                        <input type="text" name="nama_pegawai" class="form-control form-control-user" required="requeired">
                        Alamat :
                        <input type="varchar" name="alamat" class="form-control form-control-user" required="requeired">
                        Pendidikan :
                        <input type="varchar" name="pendidikan" class="form-control form-control-user" required="requeired">
                        No.Telpon :
                        <input type="varchar" name="no_telp" class="form-control form-control-user" required="requeired">
                        Jabatan :
                        <input type="text" name="jabatan" class="form-control form-control-user" required="requeired">
