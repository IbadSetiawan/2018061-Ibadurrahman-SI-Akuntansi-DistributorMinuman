        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/pegawai/pegawai_update" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="id_pegawai" value="{{ $pegawai->id_pegawai }}">
                        Id Pegawai :
                        <input type="password" class="form-control form-control-user" required="requeired" name="id_pegawai" value="{{ $pegawai->id_pegawai }}">
                        Nama Pegawai :
                        <input type="text" name="nama_pegawai" class="form-control form-control-user" required="requeired" value="{{ $pegawai->nama_pegawai }}">
                        Alamat :
                        <input type="varchar" name="alamat" class="form-control form-control-user" required=requeired value="{{ $pegawai->alamat }}">
                        Pendidikan :
                        <input type="varchar" name="pendidikan" class="form-control form-control-user" required="requeired" value="{{$pegawai->pendidikan }}">
                        No.Telpon :
                        <input type="varchar" name="no_telp" class="form-control form-control-user" required="requeired" value="{{ $pegawai->no_telp }}">
                        Jabatan :
                        <input type="text" name="jabatan" class="form-control form-control-user" required="requeired" value="{{$pegawai->jabatan }}">
