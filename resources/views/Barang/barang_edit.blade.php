        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/barang/barang_update" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="id_barang" value="{{ $barang->id_barang }}">
                        Id Barang :
                        <input type="password" class="form-control form-control-user" required="requeired" name="id_barang" value="{{ $barang->id_barang }}">
                        ID Pegawai :
                        ...
                        Merk :
                        <input type="text" name="merk" class="form-control form-control-user" required="requeired" value="{{ $barang->merk }}">
                        Harga :
                        <input type="int" name="harga" class="form-control form-control-user" required="requeired" value="{{ $barang->harga }}">
                        Barang Masuk :
                        <input type="int" name="masuk" class="form-control form-control-user" required="requeired" value="{{ $barang->masuk }}">
                        Barang Keluar :
                        <input type="int" name="keluar" class="form-control form-control-user" required="requeired" value="{{ $barang->keluar }}">
                        Total :
                        <input type="int" name="total" class="form-control form-control-user" required="requeired" value="{{ $barang->total }}">
                        Tanggal :
                        <input type="date" name="tanggal" class="form-control form-control-user" required="requeired" value="{{ $barang->tanggal }}">
