    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="/barang/barang_store" method="post">
                        {{csrf_field()}}
                        ID Barang :
                        <input type="varchar" name="id_barang" class="form-control form-control-user" required="requeired">
                        ID Pegawai :
                        ...
                        Harga :
                        <input type="int" name="harga" class="form-control form-control-user" required="requeired">
                        Barang Masuk :
                        <input type="int" name="masuk" class="form-control form-control-user" required="requeired">
                        Barang Keluar :
                        <input type="int" name="keluar" class="form-control form-control-user" required="requeired">
                        Total Barang:
